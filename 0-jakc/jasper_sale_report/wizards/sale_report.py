...
class sale_report(osv.osv_memory):
    ...
    _columns = {
        'report_id': fields.selection([
            ...
            ('04', 'Laporan Jual Pelanggan'),

        ], 'Report Name'),
        'start_date': fields.date('Start Date'),
        'end_date': fields.date('End Date'),
        'sales_ids': fields.many2many('res.users', 'sales_report_users_rel', 'order_id', 'user_id', 'Sales'),
    }
    ...
    def generate_report(self, cr, uid, ids, context=None):
        ...
        if param.report_id == '04':
            ...
            return self.pool['report'].get_action(cr, uid, [],
                                                  'jasper_sale_report.report_customersale_summary',
                                                  data=datas,
                                                  context=context)
